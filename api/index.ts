 ...
 *
 * This file is at the monorepo root api/ directory so Vercel finds it automatically.
 * It directly imports the backend source (which Vercel bundles via TypeScript transpilation).
 *
...
function buildApp(): Promise<ReturnType<typeof createApp>> {
